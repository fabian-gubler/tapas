...
HTTP/2 201
date: Sun, 13 Nov 2022 18:35:12 GMT
...
date: Sun, 13 Nov 2022 18:33:21 GMT
content-length: 186
...
HTTP/2 200
content-type: application/json
date: Sun, 13 Nov 2022 18:50:17 GMT
content-length: 371
...
HTTP/2 204
date: Sun, 13 Nov 2022 18:38:56 GMT
```
...
HTTP/2 200
date: Sun, 13 Nov 2022 19:14:02 GMT
content-length: 0
```
...
HTTP/2 200
date: Sun, 13 Nov 2022 19:24:14 GMT
content-length: 0
```

This functionality is fully implemented. If there is a problem with the resource directory, the
Auction House returns a `503 Service Unavailable` status code. If no directory URI is given (either
in the `*.properties` file or in the request payload), the Auction House returns a `400 Bad Request`.
...
HTTP/2 200
date: Sun, 13 Nov 2022 20:02:28 GMT
content-length: 0
```
