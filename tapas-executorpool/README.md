...
* a JSON-based format for task with the media type `application/task+json`; this media type is defined
  ...
  [TaskJsonRepresentation](src/main/java/ch/unisg/tapasexecutorpool/executorpool/adapter/in/formats/ExecutorJsonRepresentation.java)
  for more details)
...
(see [TaskJsonRepresentation](src/main/java/ch/unisg/tapasexecutorpool/executorpool/adapter/in/formats/ExecutorJsonRepresentation.java)
for more details):
...
[TaskExecutedEvent](src/main/java/ch/unisg/tapasexecutorpool/executorpool/application/port/in/TaskExecutedEvent.java).
