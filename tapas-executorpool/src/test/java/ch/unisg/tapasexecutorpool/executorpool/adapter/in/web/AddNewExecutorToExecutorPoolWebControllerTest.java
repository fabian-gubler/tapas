...
public class AddNewExecutorToExecutorPoolWebControllerTest {
    ...
    public void addNewExecutorToExecutorPool() throws Exception {
        ...
        mvc.perform(MockMvcRequestBuilders.post("/executors/")
    ...
    @Test
    public void shouldAddNewExecutor() throws Exception {
        ...
        mvc.perform(MockMvcRequestBuilders.post("/executors/")
            ...
            .content(jsonPayLoad))
            .andExpect(status().isCreated());
            //.andExpect(jsonPath("$.endpoint").value(executor.getEndpoint().getValue()))
    }
